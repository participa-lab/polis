...
s.pctAgreedLong = "{{pct}}% de quienes votaron la opinión {{comment_id}} acordaron.";
s.pctAgreedOfGroup = "{{pct}}% de Grupo {{group}} acordaron";
s.pctDisagreedOfGroup = "{{pct}}% de Grupo {{group}} discreparon";
s.pctDisagreedLong = "{{pct}}% de quienes votaron la opinión {{comment_id}} discreparon.";
s.pctAgreedOfGroupLong = "{{pct}}% del grupo {{group}} que votaron la opinión {{comment_id}} acordaron.";
s.pctDisagreedOfGroupLong = "{{pct}}% del grupo {{group}} que votaron la opinión {{comment_id}} discreparon.";
